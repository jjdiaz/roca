...
use Roca\Bundle\RefdataBundle\Entity\Distinction;
use Roca\Bundle\RefdataBundle\Entity\Solution;
use Symfony\Component\Serializer\Normalizer\NormalizerInterface;
use Symfony\Component\Serializer\Normalizer\scalar;


class DistinctionNormalizer implements NormalizerInterface
{
    /** @var string[] */
    ...
    {
        return $data instanceof Distinction  && in_array($format, $this->supportedFormats);
    }
