        ...
        return BaseForm.extend({
            ...
            render() {
                this.$el.html(this.template({
                    cloudname: 'Pepe',
                    // cloudname: this.getFormData()['asm_cloudinary___cloud_name'] ?
                    //     this.getFormData()['asm_cloudinary___cloud_name'] : '',
                    apikey: this.getFormData()['asm_cloudinary___api_key'] ?
                        this.getFormData()['asm_cloudinary___api_key'] : '',
                    apisecret: this.getFormData()['asm_cloudinary___api_secret'] ?
                        this.getFormData()['asm_cloudinary___api_secret'] : '',
                }));
